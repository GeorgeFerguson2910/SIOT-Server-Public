...
import { omit, checkMissingField, checkUnique, errorResponseHandler, ValidationError, successResponseCreated, successResponse } from "../helpers.js";
var adminController = {}; // creates a new admin

adminController.createAdmin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, firstName, lastName, email, password, fields, admins, hash, admin, newAdmin;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 15:
            ...
            return _context.abrupt("return", successResponseCreated(res, {
              admin: omit(admin, ["password", "is_deleted", "__v", "_id", "created_at"])
            }));
